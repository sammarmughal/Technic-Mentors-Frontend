...
export default function SeoTags() {
    ...
    useEffect(() => {
        if (pathname === "/") {
            ...
            setName("About")
            setTitle("Know About Best Software Company - Technic Mentors")
            setUrl("https://technicmentors.com/about/")
            setImg("https://technicmentors.com/assets/img/technologies.webp")
            setDescription("Technic mentors is the best software company to look at when searching for extraordinary software and technology solutions.")
            ...
            setTitle("Our Portfolio - Technic Mentors")
            ...
            setDescription("Web development services encompass two essential steps: web design and web development. Web design focuses on the aesthetics.")
            ...
            setTitle("Offering Best SEO Services In Pakistan - Technic Mentors")
            setUrl("https://technicmentors.com/seo-services/")
            setImg("https://technicmentors.com/assets/img/seo-services.gif")
            setDescription("Our SEO services in Pakistan involve optimizing your website to improve its ranking on search engine result pages when users search for products or services.")
            ...
            setTitle("Best School Management Software - Technic Mentors")
            ...
            setTitle("Intelligent ERP Software In Pakistan - Technic Mentors")
            setUrl("https://technicmentors.com/erp-solutions/")
            setImg("https://technicmentors.com/assets/img/erp-accounting-software.webp")
            setDescription("We offer a full range of value-added ERP software in Pakistan and Customer Relationship Management services for customers.")
        } else if (pathname === "/ecommerce-solutions") {
            setName("Ecommerce Solutions")
            setTitle("Ecommerce Software Development Services - Technic Mentors")
            setUrl("https://technicmentors.com/ecommerce-solutions/")
            setImg("https://technicmentors.com/assets/img/ecommerce-solutions.webp")
            setDescription("Our Ecommerce software development is designed to help your business thrive in the competitive online landscape. We offer a user-friendly platform.")
        } else if (pathname === "/point-of-sale") {
            setName("Point Of Sale")
            setTitle("Best Software For Retail Shop - Technic Mentors")
            setUrl("https://technicmentors.com/point-of-sale/")
            setImg("https://technicmentors.com/assets/img/point-of-sale.webp")
            setDescription("The efficiency and effectiveness of your Point of Sale (POS) system can make all the difference. Our cutting-edge software for retail shop..")
        } else if (pathname === "/industries") {
            setName("Industries")
            setTitle("Industries We Serve In Technologically-Driven World")
            ...
            setName("Contact")
            setTitle("Get In Touch With Us - Technic Mentors")
            setUrl("https://technicmentors.com/contact/")
            setDescription("Have any query? Our support team is always there to respond you. Just drop a message here and get in touch with us.")
        } else {
            setName("Technic Mentors")
            setTitle("Top IT Services Company - Technic Mentors")
            setUrl("https://technicmentors.com/")
            setImg("https://technicmentors.com/static/media/technicblue.524a6a4b92880f2eb36b.png")
            setDescription("Enhance your business operations and technological capabilities by partnering with the ideal IT services company to provide tailored solutions and support..")
