          ...
          <div className="row d-flex text-center justify-content-center" data-aos="fade-up" data-aos-duration="1000" data-aos-easing="ease-in-out">
            ...
            <div className="col-md-6 mt-1">
              <div data-aos="fade-up" data-aos-duration="1000" data-aos-easing="ease-in-out" className='text-center' >
                <div className="services-list" style={{ listStyle: "none", textAlign: "left", color: "#684df4" }}> <p> Java, PHP, SQL & others </p></div>
                ...
                <li className="services-list" style={{ listStyle: "none", textAlign: "left", color: "#684df4" }}> <p> Create complex databases for organizations </p></li>
                ...
                <li className="services-list" style={{ listStyle: "none", textAlign: "left", color: "#684df4" }}> <p> C# and .Net programming </p></li>
            ...
            <div className="col-md-6 mt-1">
              <div data-aos="fade-up" data-aos-duration="1000" data-aos-easing="ease-in-out" className='text-center' >
                <li className="services-list" style={{ listStyle: "none", textAlign: "left", color: "#684df4" }}> <p> Software Quality Assurance </p></li>
                ...
                <li className="services-list" style={{ listStyle: "none", textAlign: "left", color: "#684df4" }}> <p> Comfortable Writing and analyzing SQL queries </p></li>
                ...
                <li className="services-list" style={{ listStyle: "none", textAlign: "left", color: "#684df4" }}> <p> Build business logic of software </p></li>
