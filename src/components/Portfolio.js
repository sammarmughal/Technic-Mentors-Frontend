    ...
    <div>
        ...
        <div className="container">
          <div className="row" data-aos="fade-up" data-aos-duration="1000" data-aos-easing="ease-in-out">
            <div className="col-md-6">
              ...
              <p>
                Our exclusive portfolio represents our passion for creativity and client
      ...
      >
        <div className="container mt-4">
          <div className="section-title mb-3 text-center" style={{ paddingBottom: "0" }}>
          ...
          <div className="row justify-content-center">
            <div className="col-md-10">
              <p className="mb-4 text-center">Our Portfolio of Web Development Projects showcases the diverse range of websites we've created for clients across various industries. From sleek corporate websites to dynamic ecommerce platforms, each project reflects our commitment to quality, innovation, and user experience. Our portfolio highlights custom designs tailored to each client's needs, ensuring functionality and visual appeal. Whether it's educational websites that promote learning, service-oriented sites that drive business, or creative portfolio pages that showcase talent, our web development projects demonstrate our versatility and expertise in delivering top-tier digital solutions. Explore our portfolio to see how we bring visions to life.</p>
            </div>
          </div>
          <div className="container">
            <div className="row">
            ...
            <div className="row ">
              ...
              <div className="col-md-3 mb-3  ">
                ...
                <div className="portfolio-title text-center">
                  <p className="mt-2" style={{ backgroundColor: "white" }} >BCD SERVICES</p>
                </div>
              </div>
            </div>
            <div className="row">
